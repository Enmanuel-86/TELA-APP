...
# Form implementation generated from reading ui file 'C:/Users/Enman/Documents/Enmanuel/trabajos uni Enmanuel/Proyecto Tela/Sistema_de_informacion_con_PyQt5/elementos_graficos_ui/pantalla_de_vista_general_de_alumnos.ui'
#
...
class Ui_VistaGeneralDeAlumnos(object):
    def setupUi(self, VistaGeneralDeAlumnos):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1207, 614))
...
"}")
        ...
        self.imagen_contador.setPixmap(QtGui.QPixmap("C:/Users/Enman/Documents/Enmanuel/trabajos uni Enmanuel/Proyecto Tela/Sistema_de_informacion_con_PyQt5/elementos_graficos_ui\\../recursos_de_imagenes/iconos_de_interfaz/icono_de_usuario.png"))
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:/Users/Enman/Documents/Enmanuel/trabajos uni Enmanuel/Proyecto Tela/Sistema_de_informacion_con_PyQt5/elementos_graficos_ui\\../recursos_de_imagenes/iconos_de_interfaz/nuevo_registro.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:/Users/Enman/Documents/Enmanuel/trabajos uni Enmanuel/Proyecto Tela/Sistema_de_informacion_con_PyQt5/elementos_graficos_ui\\../recursos_de_imagenes/iconos_de_interfaz/generar_informe.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.boton_generar_informe.setIcon(icon3)
        ...
        self.boton_de_editar = QtWidgets.QPushButton(self.espacio_botones)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.boton_de_editar.sizePolicy().hasHeightForWidth())
        self.boton_de_editar.setSizePolicy(sizePolicy)
        self.boton_de_editar.setMinimumSize(QtCore.QSize(120, 40))
        self.boton_de_editar.setMaximumSize(QtCore.QSize(250, 400))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.boton_de_editar.setFont(font)
        self.boton_de_editar.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.boton_de_editar.setStyleSheet("QPushButton{\n"
"\n"
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:/Users/Enman/Documents/Enmanuel/trabajos uni Enmanuel/Proyecto Tela/Sistema_de_informacion_con_PyQt5/elementos_graficos_ui\\../recursos_de_imagenes/iconos_de_interfaz/editar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.boton_de_editar.setIcon(icon4)
        self.boton_de_editar.setIconSize(QtCore.QSize(26, 26))
        self.boton_de_editar.setObjectName("boton_de_editar")
        self.botones_de_opciones.addWidget(self.boton_de_editar, 0, 3, 1, 1)
        self.boton_de_borrar = QtWidgets.QPushButton(self.espacio_botones)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.boton_de_borrar.sizePolicy().hasHeightForWidth())
        self.boton_de_borrar.setSizePolicy(sizePolicy)
        self.boton_de_borrar.setMinimumSize(QtCore.QSize(120, 40))
        self.boton_de_borrar.setMaximumSize(QtCore.QSize(200, 400))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.boton_de_borrar.setFont(font)
        self.boton_de_borrar.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.boton_de_borrar.setStyleSheet("QPushButton{\n"
"\n"
...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/Users/Enman/Documents/Enmanuel/trabajos uni Enmanuel/Proyecto Tela/Sistema_de_informacion_con_PyQt5/elementos_graficos_ui\\../recursos_de_imagenes/iconos_de_interfaz/borrar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.boton_de_borrar.setIcon(icon5)
        self.boton_de_borrar.setIconSize(QtCore.QSize(26, 26))
        self.boton_de_borrar.setObjectName("boton_de_borrar")
        self.botones_de_opciones.addWidget(self.boton_de_borrar, 0, 2, 1, 1)
    ...
    def retranslateUi(self, VistaGeneralDeAlumnos):
        ...
        self.boton_de_editar.setText(_translate("VistaGeneralDeAlumnos", "  Editar"))
        self.boton_de_borrar.setText(_translate("VistaGeneralDeAlumnos", "  Borrar"))
