...
# Form implementation generated from reading ui file 'C:/Users/Enman/Documents/Enmanuel/trabajos uni Enmanuel/Proyecto Tela/Sistema_de_informacion_con_PyQt5/elementos_graficos_ui/ventana_mostrar_diagnosticos.ui'
#
...
class Ui_VentanaMostrarDiagnosticoRegistrado(object):
    def setupUi(self, MostrarDiagnosticosRegistrado):
        MostrarDiagnosticosRegistrado.setObjectName("MostrarDiagnosticosRegistrado")
        MostrarDiagnosticosRegistrado.setEnabled(True)
        MostrarDiagnosticosRegistrado.resize(607, 477)
        MostrarDiagnosticosRegistrado.setMinimumSize(QtCore.QSize(607, 477))
        MostrarDiagnosticosRegistrado.setMaximumSize(QtCore.QSize(607, 477))
        self.verticalLayout = QtWidgets.QVBoxLayout(MostrarDiagnosticosRegistrado)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.espacio_principal = QtWidgets.QFrame(MostrarDiagnosticosRegistrado)
...
" ")
        ...
        self.retranslateUi(MostrarDiagnosticosRegistrado)
        QtCore.QMetaObject.connectSlotsByName(MostrarDiagnosticosRegistrado)

    def retranslateUi(self, MostrarDiagnosticosRegistrado):
        _translate = QtCore.QCoreApplication.translate
        MostrarDiagnosticosRegistrado.setWindowTitle(_translate("MostrarDiagnosticosRegistrado", "Form"))
        self.titulo.setText(_translate("MostrarDiagnosticosRegistrado", "Diagnóstico N° #"))
        self.label_diagnostico.setText(_translate("MostrarDiagnosticosRegistrado", "Diagnóstico"))
        self.label_fecha_diagnostico.setText(_translate("MostrarDiagnosticosRegistrado", "Fecha del diagnóstico"))
        self.label_fecha_venc_certificado.setText(_translate("MostrarDiagnosticosRegistrado", "Fecha de venc del certificado de discapacidad"))
        self.label_medico_tratante.setText(_translate("MostrarDiagnosticosRegistrado", "Medico Tratante"))
        self.label_certificado_discap.setText(_translate("MostrarDiagnosticosRegistrado", "Certificado de discapacidad"))
        self.label_medicacion.setText(_translate("MostrarDiagnosticosRegistrado", "Medicación"))
