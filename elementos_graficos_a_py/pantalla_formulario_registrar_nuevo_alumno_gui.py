...
class Ui_FormularioNuevoRegistroAlumnos(object):
    def setupUi(self, FormularioNuevoRegistroAlumnos):
        ...
        FormularioNuevoRegistroAlumnos.resize(1054, 1409)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1062, 2702))
...
"}")
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.datos_del_alumno)
...
"")
        ...
        self.boton_fecha_de_ingreso_tela = QtWidgets.QPushButton(self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.boton_fecha_de_ingreso_tela.sizePolicy().hasHeightForWidth())
        self.boton_fecha_de_ingreso_tela.setSizePolicy(sizePolicy)
...
"    background-color: rgb(199, 199, 199)\n"
"}")
        self.boton_fecha_de_ingreso_tela.setIcon(icon2)
...
"border:none;")
        ...
        self.gridLayout_8 = QtWidgets.QGridLayout(self.pregunta_diagnostico_alumno)
...
"}")
        ...
        self.gridLayout_8.addLayout(self.verticalLayout_34, 0, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_8.addLayout(self.gridLayout_14, 0, 1, 1, 1)
...
"}")
        ...
        self.gridLayout_8.addLayout(self.verticalLayout_37, 0, 2, 4, 1)
...
"")
        ...
        self.gridLayout_8.addLayout(self.verticalLayout_33, 1, 0, 1, 1)
...
"")
        ...
        self.gridLayout_8.addLayout(self.verticalLayout_36, 1, 1, 1, 1)
        self.gridLayout_5 = QtWidgets.QGridLayout()
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.boton_para_agregar_fecha_diagnostico = QtWidgets.QPushButton(self.pregunta_diagnostico_alumno)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.boton_para_agregar_fecha_diagnostico.sizePolicy().hasHeightForWidth())
        self.boton_para_agregar_fecha_diagnostico.setSizePolicy(sizePolicy)
        self.boton_para_agregar_fecha_diagnostico.setMinimumSize(QtCore.QSize(110, 35))
        self.boton_para_agregar_fecha_diagnostico.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.boton_para_agregar_fecha_diagnostico.setStyleSheet("QPushButton{\n"
"\n"
"    border: 1px solid black;\n"
"    border-radius:10px;\n"
"}\n"
...
"    background-color: rgb(199, 199, 199)\n"
"}")
        self.boton_para_agregar_fecha_diagnostico.setIcon(icon2)
        self.boton_para_agregar_fecha_diagnostico.setIconSize(QtCore.QSize(20, 20))
        self.boton_para_agregar_fecha_diagnostico.setObjectName("boton_para_agregar_fecha_diagnostico")
        self.gridLayout_5.addWidget(self.boton_para_agregar_fecha_diagnostico, 1, 0, 1, 1, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.label_mostrar_fecha_diagnostico = QtWidgets.QLabel(self.pregunta_diagnostico_alumno)
        self.label_mostrar_fecha_diagnostico.setMinimumSize(QtCore.QSize(90, 30))
        self.label_mostrar_fecha_diagnostico.setMaximumSize(QtCore.QSize(90, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.gridLayout_5.addWidget(self.label_mostrar_fecha_diagnostico, 1, 1, 1, 1, QtCore.Qt.AlignLeft)
        self.label_fecha_diagnostico = QtWidgets.QLabel(self.pregunta_diagnostico_alumno)
...
"")
        ...
        self.gridLayout_5.addWidget(self.label_fecha_diagnostico, 0, 0, 1, 2, QtCore.Qt.AlignBottom)
...
"")
        ...
        self.gridLayout_8.addLayout(self.verticalLayout_35, 2, 1, 1, 1)
        self.gridLayout_12 = QtWidgets.QGridLayout()
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.label_fecha_del_certificado = QtWidgets.QLabel(self.pregunta_diagnostico_alumno)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
...
"")
        ...
        self.gridLayout_12.addWidget(self.label_fecha_del_certificado, 0, 0, 1, 2, QtCore.Qt.AlignLeft)
        self.boton_para_agregar_fecha_certificado = QtWidgets.QPushButton(self.pregunta_diagnostico_alumno)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.boton_para_agregar_fecha_certificado.sizePolicy().hasHeightForWidth())
        self.boton_para_agregar_fecha_certificado.setSizePolicy(sizePolicy)
        self.boton_para_agregar_fecha_certificado.setMinimumSize(QtCore.QSize(110, 35))
        self.boton_para_agregar_fecha_certificado.setMaximumSize(QtCore.QSize(16777215, 16777213))
        self.boton_para_agregar_fecha_certificado.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.boton_para_agregar_fecha_certificado.setStyleSheet("QPushButton{\n"
"\n"
"    border: 1px solid black;\n"
"    border-radius:10px;\n"
"}\n"
...
"    background-color: rgb(199, 199, 199)\n"
"}")
        self.boton_para_agregar_fecha_certificado.setIcon(icon2)
        self.boton_para_agregar_fecha_certificado.setIconSize(QtCore.QSize(20, 20))
        self.boton_para_agregar_fecha_certificado.setObjectName("boton_para_agregar_fecha_certificado")
        self.gridLayout_12.addWidget(self.boton_para_agregar_fecha_certificado, 1, 0, 1, 1, QtCore.Qt.AlignLeft)
        self.label_mostrar_fecha_certificado = QtWidgets.QLabel(self.pregunta_diagnostico_alumno)
        self.label_mostrar_fecha_certificado.setMinimumSize(QtCore.QSize(90, 30))
        self.label_mostrar_fecha_certificado.setMaximumSize(QtCore.QSize(90, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.label_mostrar_fecha_certificado.setFont(font)
        self.label_mostrar_fecha_certificado.setText("")
        self.label_mostrar_fecha_certificado.setObjectName("label_mostrar_fecha_certificado")
        self.gridLayout_12.addWidget(self.label_mostrar_fecha_certificado, 1, 1, 1, 1, QtCore.Qt.AlignLeft)
        self.gridLayout_8.addLayout(self.gridLayout_12, 3, 0, 1, 1)
...
"")
        ...
        self.gridLayout_8.addLayout(self.verticalLayout_45, 3, 1, 1, 1)
...
"\n"
"}")
        self.boton_anadir_diagnostico.setIcon(icon4)
        ...
        self.gridLayout_8.addWidget(self.boton_anadir_diagnostico, 4, 1, 1, 1)
        self.verticalLayout_10.addWidget(self.pregunta_diagnostico_alumno, 0, QtCore.Qt.AlignVCenter)
...
"")
        ...
        self.boton_turno.setProperty("placeholderText", "")
...
"")
        ...
        self.label_fecha_de_ingreso_especialidad = QtWidgets.QLabel(self.frame_3)
...
"")
        ...
        self.gridLayout_15.addWidget(self.label_fecha_de_ingreso_especialidad, 0, 0, 1, 2)
        self.boton_fecha_de_ingreso_especialidad = QtWidgets.QPushButton(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.boton_fecha_de_ingreso_especialidad.sizePolicy().hasHeightForWidth())
        self.boton_fecha_de_ingreso_especialidad.setSizePolicy(sizePolicy)
        self.boton_fecha_de_ingreso_especialidad.setMinimumSize(QtCore.QSize(110, 30))
        self.boton_fecha_de_ingreso_especialidad.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.boton_fecha_de_ingreso_especialidad.setStyleSheet("QPushButton{\n"
"\n"
"    border: 1px solid black;\n"
"    border-radius:10px;\n"
"}\n"
...
"    background-color: rgb(199, 199, 199)\n"
"}")
        self.boton_fecha_de_ingreso_especialidad.setIcon(icon2)
        self.boton_fecha_de_ingreso_especialidad.setIconSize(QtCore.QSize(20, 20))
        self.boton_fecha_de_ingreso_especialidad.setObjectName("boton_fecha_de_ingreso_especialidad")
        self.gridLayout_15.addWidget(self.boton_fecha_de_ingreso_especialidad, 1, 0, 1, 1)
        self.label_mostrar_fecha_de_ingreso_especialidad = QtWidgets.QLabel(self.frame_3)
        self.label_mostrar_fecha_de_ingreso_especialidad.setMinimumSize(QtCore.QSize(100, 0))
        self.label_mostrar_fecha_de_ingreso_especialidad.setMaximumSize(QtCore.QSize(100, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.label_mostrar_fecha_de_ingreso_especialidad.setFont(font)
        self.label_mostrar_fecha_de_ingreso_especialidad.setText("")
        ...
        FormularioNuevoRegistroAlumnos.setTabOrder(self.input_numero_de_cuenta, self.boton_diagnostico)
        FormularioNuevoRegistroAlumnos.setTabOrder(self.boton_diagnostico, self.input_otro_diagnostico)
        FormularioNuevoRegistroAlumnos.setTabOrder(self.input_otro_diagnostico, self.input_medico_tratante)
...
"border:none;"))
        ...
        self.boton_para_agregar_fecha_diagnostico.setText(_translate("FormularioNuevoRegistroAlumnos", "Agregar fecha"))
        ...
        self.boton_para_agregar_fecha_certificado.setText(_translate("FormularioNuevoRegistroAlumnos", "Agregar fecha"))
