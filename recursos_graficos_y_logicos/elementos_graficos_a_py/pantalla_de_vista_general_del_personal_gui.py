...
class Ui_VistaGeneralDelPersonal(object):
    def setupUi(self, VistaGeneralDelPersonal):
        ...
        VistaGeneralDelPersonal.resize(1325, 574)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1323, 572))
        ...
        self.espacio_para_las_opciones.setMinimumSize(QtCore.QSize(571, 0))
        self.espacio_para_las_opciones.setMaximumSize(QtCore.QSize(571, 16777215))
        ...
        self.label_boton_opciones.setMinimumSize(QtCore.QSize(81, 30))
        self.label_boton_opciones.setMaximumSize(QtCore.QSize(81, 30))
        font = QtGui.QFont()
        ...
        self.gridLayout_2.addWidget(self.label_boton_opciones, 0, 0, 1, 1)
        self.label_especialidades = QtWidgets.QLabel(self.espacio_para_las_opciones)
        self.label_especialidades.setMinimumSize(QtCore.QSize(111, 20))
        self.label_especialidades.setMaximumSize(QtCore.QSize(111, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(19)
        font.setBold(True)
        ...
        self.gridLayout_2.addWidget(self.label_especialidades, 0, 1, 1, 1)
        self.label_boton_situacion = QtWidgets.QLabel(self.espacio_para_las_opciones)
        self.label_boton_situacion.setMinimumSize(QtCore.QSize(81, 30))
        self.label_boton_situacion.setMaximumSize(QtCore.QSize(81, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(19)
        font.setBold(True)
        font.setWeight(75)
        self.label_boton_situacion.setFont(font)
        self.label_boton_situacion.setStyleSheet("")
        self.label_boton_situacion.setObjectName("label_boton_situacion")
        self.gridLayout_2.addWidget(self.label_boton_situacion, 0, 2, 1, 1)
        ...
        self.boton_de_opciones.setMinimumSize(QtCore.QSize(181, 41))
        self.boton_de_opciones.setMaximumSize(QtCore.QSize(181, 41))
        ...
        self.gridLayout_2.addWidget(self.boton_de_opciones, 1, 0, 1, 1)
        ...
        self.boton_de_situacion = QtWidgets.QComboBox(self.espacio_para_las_opciones)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.boton_de_situacion.sizePolicy().hasHeightForWidth())
        self.boton_de_situacion.setSizePolicy(sizePolicy)
        self.boton_de_situacion.setMinimumSize(QtCore.QSize(181, 41))
        self.boton_de_situacion.setMaximumSize(QtCore.QSize(181, 41))
        self.boton_de_situacion.setStyleSheet("")
        self.boton_de_situacion.setEditable(False)
        self.boton_de_situacion.setInsertPolicy(QtWidgets.QComboBox.NoInsert)
        self.boton_de_situacion.setIconSize(QtCore.QSize(40, 40))
        self.boton_de_situacion.setPlaceholderText("")
        ...
        self.espacio_para_barra_de_busqueda.setMinimumSize(QtCore.QSize(421, 0))
...
"}")
        ...
        self.gridLayout.addWidget(self.imagen_contador, 1, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout.addWidget(self.label_titulo_contador, 0, 1, 1, 2, QtCore.Qt.AlignHCenter)
...
"}")
        ...
        self.gridLayout.addWidget(self.label_contador, 1, 2, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.boton_control_de_llegada.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/iconos/recursos_de_imagenes/iconos_de_interfaz/clipboard-plus-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.boton_control_de_reposos.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/iconos/recursos_de_imagenes/iconos_de_interfaz/user-round-plus-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.boton_de_situacion.setCurrentIndex(0)
    ...
    def retranslateUi(self, VistaGeneralDelPersonal):
        ...
        self.label_boton_situacion.setText(_translate("VistaGeneralDelPersonal", "Situación"))
        self.label_boton_situacion.setProperty("tipo", _translate("VistaGeneralDelPersonal", "titulo_qlineedit"))
        self.boton_de_situacion.setCurrentText(_translate("VistaGeneralDelPersonal", "Activo"))
        self.boton_de_situacion.setItemText(0, _translate("VistaGeneralDelPersonal", "Activo"))
        self.boton_de_situacion.setItemText(1, _translate("VistaGeneralDelPersonal", "Inactivo"))
