...
class Ui_VentanaPrincipal(object):
    def setupUi(self, VentanaPrincipal):
        ...
        VentanaPrincipal.resize(891, 1107)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 184, 1042))
...
"QPushButton:disabled{\\n\\n    \\n    background-color: rgb(0, 92, 47)}")
        ...
        self.verticalLayout_2.addWidget(self.boton_salir, 0, QtCore.Qt.AlignBottom)
