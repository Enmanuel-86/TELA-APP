...
class Ui_PantallaControlDeLlegada(object):
    def setupUi(self, PantallaControlDeLlegada):
        ...
        PantallaControlDeLlegada.resize(1264, 687)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -42, 1247, 729))
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.espacio_superior, 0, QtCore.Qt.AlignHCenter)
...
"}")
    ...
    def retranslateUi(self, PantallaControlDeLlegada):
        ...
        self.label_nombre_empleado_guia.setProperty("tipo", _translate("PantallaControlDeLlegada", "titulo_qlineedit"))
