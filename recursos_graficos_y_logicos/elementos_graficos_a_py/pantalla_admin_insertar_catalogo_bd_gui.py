...
"}")
        ...
        self.label_tipo_cargo_empleado_2 = QtWidgets.QLabel(self.espacio_catalogo_cargos_empleado_2)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.label_tipo_cargo_empleado_2.setFont(font)
        self.label_tipo_cargo_empleado_2.setStyleSheet("")
        self.label_tipo_cargo_empleado_2.setObjectName("label_tipo_cargo_empleado_2")
        self.verticalLayout_16.addWidget(self.label_tipo_cargo_empleado_2)
        self.input_hora_cargo_empleado = QtWidgets.QTimeEdit(self.espacio_catalogo_cargos_empleado_2)
        self.input_hora_cargo_empleado.setMinimumSize(QtCore.QSize(150, 40))
        self.input_hora_cargo_empleado.setMaximumSize(QtCore.QSize(150, 40))
        self.input_hora_cargo_empleado.setCurrentSectionIndex(0)
...
"}")
    ...
    def retranslateUi(self, PantallaInsertarCatalogoBD):
        ...
        self.label_tipo_cargo_empleado_2.setText(_translate("PantallaInsertarCatalogoBD", "Hora de llegada"))
        self.label_tipo_cargo_empleado_2.setProperty("tipo", _translate("PantallaInsertarCatalogoBD", "titulo_qlineedit"))
        self.input_hora_cargo_empleado.setDisplayFormat(_translate("PantallaInsertarCatalogoBD", "h:mm"))
