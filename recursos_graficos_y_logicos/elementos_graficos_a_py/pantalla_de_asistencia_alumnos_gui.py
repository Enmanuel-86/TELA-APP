...
class Ui_PantallaAsistenciaAlumnos(object):
    def setupUi(self, PantallaAsistenciaAlumnos):
        ...
        PantallaAsistenciaAlumnos.resize(1325, 737)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1308, 785))
...
"}")
        ...
        self.label_imagen_asistencia.setPixmap(QtGui.QPixmap(":/iconos/iconos_de_interfaz/asistencia.png"))
...
"}")
        ...
        self.verticalLayout_2.addWidget(self.espacio_superior, 0, QtCore.Qt.AlignHCenter)
        ...
        self.espacio_para_tabla_empleados.setStyleSheet("QFrame{\n"
...
"}")
        ...
        self.input_asistente.setGeometry(QtCore.QRect(9, 23, 62, 16))
        ...
        self.input_check_dia_feriado.setGeometry(QtCore.QRect(86, 23, 71, 16))
        ...
        self.input_inasistente.setGeometry(QtCore.QRect(9, 56, 71, 16))
        ...
        self.boton_suministrar.setIcon(icon2)
        ...
        self.verticalLayout_2.addWidget(self.espacio_para_tabla_empleados, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, PantallaAsistenciaAlumnos):
        ...
        self.espacio_para_el_formulario.setProperty("tipo", _translate("PantallaAsistenciaAlumnos", "espacio_form"))
        ...
        self.label_nombre_alumno_guia.setProperty("tipo", _translate("PantallaAsistenciaAlumnos", "titulo_qlineedit"))
        ...
        self.espacio_lista_asistencia.setProperty("tipo", _translate("PantallaAsistenciaAlumnos", "espacio_form"))
