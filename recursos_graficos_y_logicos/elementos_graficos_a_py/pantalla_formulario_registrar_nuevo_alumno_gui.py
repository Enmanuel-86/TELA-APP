...
class Ui_FormularioNuevoRegistroAlumnos(object):
    def setupUi(self, FormularioNuevoRegistroAlumnos):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1340, 2757))
...
"}")
        ...
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.datos_del_representante)
        ...
        self.verticalLayout_23.addWidget(self.label_apellido_del_representante)
