...
class Ui_PantallaBienvenidaUsuario(object):
    def setupUi(self, PantallaBienvenidaUsuario):
        ...
        self.espacio_princiapl = QtWidgets.QFrame(PantallaBienvenidaUsuario)
        ...
        self.logo_zona_educativa.setPixmap(QtGui.QPixmap(":/imagenes_y_logos/recursos_de_imagenes/logo_zona_educativa.PNG"))
        ...
        self.membrete.setPixmap(QtGui.QPixmap(":/imagenes_y_logos/recursos_de_imagenes/membrete.PNG"))
        ...
        self.logo_tela.setPixmap(QtGui.QPixmap(":/imagenes_y_logos/recursos_de_imagenes/Tela.png"))
        ...
        self.logo_juventud.setPixmap(QtGui.QPixmap(":/imagenes_y_logos/recursos_de_imagenes/logo_juventud.PNG"))
        ...
        self.layout_area_de_scroll.setGeometry(QtCore.QRect(0, 0, 1246, 993))
        ...
        self.label_3.setPixmap(QtGui.QPixmap(":/imagenes_y_logos/recursos_de_imagenes/logo_pdf.png"))
        ...
        self.label_logo_tela_app.setPixmap(QtGui.QPixmap(":/imagenes_y_logos/recursos_de_imagenes/icono_sistema_V3.png"))
        ...
        self.gridLayout.addWidget(self.espacio_contenido, 1, 0, 1, 1)
...
"}")
        ...
        self.label_4.setPixmap(QtGui.QPixmap(":/imagenes_y_logos/recursos_de_imagenes/github_logo.png"))
...
"}")
    ...
    def retranslateUi(self, PantallaBienvenidaUsuario):
        ...
        self.label_mensaje_bienvenida.setText(_translate("PantallaBienvenidaUsuario", "<html><head/><body><p align=\"justify\"><span style=\" font-size:11pt; font-weight:600;\">El TELA-APP, es un sistema de información que se encarga de gestionar toda la información del Taller de Educación Laboral Anzoátegui.</span></p><p align=\"justify\"><span style=\" font-size:11pt; font-weight:600;\">Aqui puedes:</span></p><p align=\"justify\"><span style=\" font-size:12pt;\">- Registrar a empleados y alumnos</span></p><p align=\"justify\"><span style=\" font-size:12pt;\">- Ver la información registrada</span></p><p align=\"justify\"><span style=\" font-size:12pt;\">- Realizar reporte de asistencia</span></p><p align=\"justify\"><span style=\" font-size:12pt;\">- Control de reposos</span></p><p align=\"justify\"><br/></p><p align=\"justify\"><br/></p></body></html>"))
        self.label_mensaje_bienvenida.setProperty("tipo", _translate("PantallaBienvenidaUsuario", "texto"))
        self.frame_4.setProperty("tipo", _translate("PantallaBienvenidaUsuario", "espacio_form"))
        self.label_titulo_alumno_3.setText(_translate("PantallaBienvenidaUsuario", "¿Quieres saber cómo se hizo y cómo funciona el sistema?"))
        self.label_titulo_alumno_3.setProperty("tipo", _translate("PantallaBienvenidaUsuario", "titulo_segmento"))
        self.label_alumnos_5.setText(_translate("PantallaBienvenidaUsuario", "Si quieres saber sobre este sistema puedes acceder al repositorio de GitHub y ver el código fuente o descargar alguna actualización.\n"
""))
