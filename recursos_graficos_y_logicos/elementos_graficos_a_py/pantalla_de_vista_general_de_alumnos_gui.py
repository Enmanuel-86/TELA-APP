...
class Ui_VistaGeneralDeAlumnos(object):
    def setupUi(self, VistaGeneralDeAlumnos):
        ...
        VistaGeneralDeAlumnos.resize(1475, 614)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1473, 612))
        ...
        self.espacio_para_las_opciones.setMinimumSize(QtCore.QSize(731, 90))
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 680, 74))
        ...
        self.titulo_de_boton_de_opciones_2 = QtWidgets.QLabel(self.widget)
        ...
        self.verticalLayout_6.addWidget(self.titulo_de_boton_de_opciones_2)
        self.boton_entidades = QtWidgets.QComboBox(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.boton_entidades.addItem("")
        self.verticalLayout_6.addWidget(self.boton_entidades)
        ...
        self.verticalLayout_2.addWidget(self.titulo_de_boton_de_opciones)
        ...
        self.titulo_de_boton_de_situacion = QtWidgets.QLabel(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(30)
        ...
        self.verticalLayout.addWidget(self.titulo_de_boton_de_situacion)
        ...
        self.boton_situacion.setMinimumSize(QtCore.QSize(220, 40))
        self.boton_situacion.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.boton_situacion.addItem("")
        self.boton_situacion.addItem("")
        self.verticalLayout.addWidget(self.boton_situacion)
...
"}")
        ...
        spacerItem1 = QtWidgets.QSpacerItem(183, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
